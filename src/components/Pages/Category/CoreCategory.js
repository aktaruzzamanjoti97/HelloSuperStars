...
<div className="category-footer mt-4 ">
    ...
    <i className="far fa-star text-warning mx-1"></i>  <i className="far fa-star text-warning mx-1"></i>  <span className='text-light'>Choose at least 5 Categories</span>  <i className="far fa-star text-warning mx-1"></i>  <i className="far fa-star text-warning mx-1"></i>
    </h6>
