        ...
        <div className="star-container category-contaienr py-5 bg-dark  bg-img">
          <div className="d-flex justify-content-center align-items-center">
            <div className="center-frame">
              ...
              <h6 className="category-title">CHOOSE SUPERSTARS</h6>
            </div>
          </div>
...
<OwlCarousel   center className='owl-theme' loop margin={0} items={3} mouseDrag >
  ...
  <img src="https://resources.pulse.icc-cricket.com/players/champions-trophy-2017/284/201.png"className='img-fluid ' alt="" />
<div className="text-center">
<button className='btn btn-primary star-btn'>Sakib Al Hasan</button>
</div>
  </div>
  <div class='superstar-item '>
  <img src="https://resources.pulse.icc-cricket.com/players/champions-trophy-2017/284/201.png"  alt="" className='img-fluid'  />
  <div className="text-center">
