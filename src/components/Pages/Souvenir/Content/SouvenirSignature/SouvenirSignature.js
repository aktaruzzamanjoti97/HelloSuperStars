                ...
                <div className="col-md-9">
                  <div className="my-4">
                    <div className="d-flex flex-start">
                      <h1 className="fw-bolder text-white">
                        CR7 Signature Football
                      </h1>
                    </div>

                    <p className="text-white">
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                      Ipsa similique cum qui ab fugit veniam repellendus
                      officiis, consequuntur esse culpa quibusdam aut tempore,
                  ...
                  <form className="me-5">
                    <div className="acquireForm p-3">
                      ...
                      <div>
                        ...
                        <div class="selectOption my-2">
                          <label htmlFor="">
                            <big className="text-white">Payment Method</big>
                          </label>
                        ...
                        <div className="row my-2">
                          ...
                          <div className="col-md-7">
                            <label htmlFor="">
                              <big className="text-white">Expiry date</big>
                            </label>
                            <input
                              className="form-control input-gray"
                              type="text"
                    ...
                    <div className="my-4 d-flex justify-content-end">
                      <Link to="/souvenir-applied">
                        <button className="btn btn-warning fw-bold mx-3">
                          <img
                            src={Icon}
                            alt=""
                            className="mx-2 "
                      ...
                      <button className="btn btn-secondary ">
                        <img src={Del} alt="" className="mx-2 " height={18} />{" "}
                        Dismiss Process
                      </button>
                    </div>
                  </form>
