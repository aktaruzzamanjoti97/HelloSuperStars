...
import Del from '../../../../../images/Souvenir/Icons/delete.png'
                    ...
                    <div className="row">
                        <div className="col-md-9">
                            <div className="my-4">
                                ...
                                <p className="text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa
                                    similique cum qui ab fugit veniam repellendus officiis, consequuntur esse culpa
                                    quibusdam aut tempore, incidunt ea nesciunt soluta itaque voluptas maiores.</p>
                            </div>
                            <form className="me-5">
                                ...
                                <div className="my-4 d-flex justify-content-end">
                                    ...
                                    <Link to='/souvenir-applied'><button className="btn btn-warning fw-bold mx-3">
                                        <img src={Icon} alt="" className="mx-2 " height={18} />  Apply</button>
                                    </Link>

                                    <button className="btn btn-secondary "> 
                                    <img src={Del} alt="" className="mx-2 " height={18} /> Dismiss Process</button>
