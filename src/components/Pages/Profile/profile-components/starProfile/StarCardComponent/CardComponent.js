...
import profilePhoto from "../../../../../../images/Profile/Shakibpro.png";
...
<>
  <div className="card left-col-box PostCard mb-3 mt-3 left-card-star mx-auto">
    <div className="accordion-item PostBack ">
      <h2 className="accordion-header PostBack">
        <div className="accordion-button-fx profile1-accordion-button PostBack  collapsed">
          <img src={profilePhoto} className="abx-pro-chay" alt={profilePhoto} />
    ...
    {/* <video id="my_video_1" className="video-js vjs-default-skin card-img-top img-fluid mx-auto PostImgHe" controls
      preload="none" poster={props.posterImg} data-setup='{}'>
