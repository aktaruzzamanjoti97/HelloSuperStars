...
import './GreetingsPay.css';
import BookNowPay from './GreetinsPayNow';

const GreetingsPayContent = (props) => {
        ...
        <CardContent>
            <div className="row BookNow-m-p">
                ...
                <div className="col-md-9">
                    <h4 className="BookNameText">Greetings Mizanur Rahman at Friday night online</h4>
...
export default GreetingsPayContent