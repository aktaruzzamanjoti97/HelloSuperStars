...
<>
  ...
  <div className="full-container py-3 ">
      ...
      <div className="container main-div">
        <div className="row">
              ...
              <div className="accordion" id="accordionExample">
                <div className="accordion-item left-bottom-accorion">
                  <h2 className="accordion-header" id="headingOne">
                    <button className="accordion-button profile-accordion-button-icon left-bottom-accorion collapsed"
                ...
                <div className="accordion-item mt-1 left-bottom-accorion">
                  <h2 className="accordion-header" id="headingTwo">
                    <button className="accordion-button profile-accordion-button left-bottom-accorion collapsed"
                ...
                <div className="accordion-item mt-1 left-bottom-accorion">
                  <h2 className="accordion-header" id="headingTwo">
                    <button className="accordion-button profile-accordion-button left-bottom-accorion collapsed"
                      type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false"
                      aria-controls="collapseTwo" onClick={logoutSubmit}>
                      <span>
          ...
          <div className="col-md-5 right-card-profile">
                ...
                <RightSideCard Name="Shakib Al Hasan" Msg="Coming live at 9.00 pm tonight. See you there!"
                  profileImg={Shakib} profileLogo={ShakibProfile} />
                <RightSideCard Name="Mizanur Rahman Azharee" Msg="Assalamu Walaikum Brothers, Take greetings"
                  profileImg={Azhari} profileLogo={AzhariProfile} />
                <RightSideCard Name="Ayman Sadiq" Msg="When i come to live ? This friday? let me know"
                  profileImg={Ayman} profileLogo={AymanProfile} />
                <RightSideCard Name="Ayman Sadiq" Msg="When i come to live ? This friday? let me know"
                  profileImg={Ayman} profileLogo={AymanProfile} />
    ...
    <div class="bottomleft-message d-flex ">
      <i onClick={handleClick} class="fab fa-facebook-messenger text-warning fa-4x bottomleft-icon"></i>

      {messagenger ? (
      <div class="card mx-5 message-card">
        <div className="head m-0 p-2 d-flex justify-content-around align-items-center">
          <img src={sakibal} className='img-fluid rounded-circle' height='40px' width='40px' alt="" />
          <span className='text-light fw-bold'>Sakib Al Hasan</span>
          <i class="fas fa-times-circle close-message text-light" onClick={()=>setMessenger(false)}></i>
        </div>
        <div class="card-body">

          <img src={sakibal} className='img-fluid rounded-circle' height='40px' width='40px' alt="" />
          <div className="d-flex">
            <ReactPlayer url="https://www.youtube.com/watch?v=3CaBNtaTrbo" playing={false} volume={1} width="60%"
