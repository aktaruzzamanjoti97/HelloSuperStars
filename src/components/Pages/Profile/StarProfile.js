            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mx-auto">
                  ...
                  <NavLink to="/photos" className='mx-2' >Photos</NavLink>
                  <NavLink to="/videos" className='mx-2'>Videos</NavLink>
                  <NavLink to="/souviner" className='mx-2'>Souviner</NavLink>
                  <NavLink to="/audition" className='mx-2'>Audition</NavLink>
                </Nav>
              </Navbar.Collapse>
            </Container>
          </Navbar>
