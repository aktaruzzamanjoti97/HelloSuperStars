      ...
      <div className="card bg-dark">
        ...
        <div className="row">
          <div className="col-md-4 mb-5 mt-4">
            <div className="card bg-dark mVie">
              <ReactPlayer url="https://www.youtube.com/watch?v=ysz5S6PUM-U" controls autoplay="true"
        ...
        <div className="mb-3 mt-3 row justify-content-between BTsd p-2 mb-3 ">
          ...
          <div className="col-md-2 BlackUou BlackUouZ ">
            <input type="text" placeholder="86" className="from-control wIn fw-bold mt-2" />
          </div>
        ...
        <center>
          <button className="btn px-5 w-50 btnApp mb-5 fw-bold" onClick={()=> setModalShow(true)}
            >
            Appeal Request
          </button>
        </center>

        <AuditionModal show={modalShow} onHide={()=> setModalShow(false)}
          />
          <center>
            

            {/* Page 586 */}
            <button className="btn px-5 w-50 btnApp mb-5 fw-bold" onClick={()=> setModalShow1(true)}
              >
              Apply for the certificate
            </button>
          </center>

          <AuditionModal1 show={modalShow1} onHide={()=> setModalShow1(false)}
            />
            ...
            <div className="row">
              ...
              <div className="mb-3 mt-3 row justify-content-between p-2 mb-5 ">
                ...
                <div className="col-md-4  text-center fw-bold rounded-3 text-light py-1">
                  <button className="btnAppD py-2 px-5 fw-bold">
                    Download
                  </button>
                </div>
              </div>
