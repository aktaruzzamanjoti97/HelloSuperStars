...
<>
  ...
  <div className="container-fluid ">
    <div className="d-flex justify-content-center align-items-center my-2" style={{
  ...
  <>
    <div className="ADMn mt-3 mb-3 px-3">
          ...
          <div className="container-fluid ">
            <div className="row">
              <div className="col-md-4">
                <div>
                  <Nav.Item>
                    <Nav.Link eventKey={ location.state.pending==="pending" ? "pending" : "first" }
                      className="NavAudition" style={{ position: "relative" }}>
                      <img src={roundBg} className="img-fluid" width={"100%"} alt="" />
              ...
              <div className="col-md-4">
                <div>
                  <Nav.Item>
                    <Nav.Link eventKey="second" className="NavAudition" style={{ position: "relative" }}>
                      <img src={roundBg} className="img-fluid" width={"100%"} alt="" />
                      <div className="round-content">
                        <h3 className="fw-bold">Round</h3>
                        <div>
              ...
              <div className="col-md-4">
                <div>
                  <Nav.Item>
                    <Nav.Link eventKey="third" className="NavAudition" style={{ position: "relative" }}>
                      <img src={roundBg} className="img-fluid" width={"100%"} alt="" />
                      <div className="round-content">
                        <h3 className="fw-bold">Round</h3>
                        <div>
