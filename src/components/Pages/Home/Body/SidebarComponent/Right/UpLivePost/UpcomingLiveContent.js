...
import UpComingLiveComment from "./UpComingLiveComment";
            ...
            <div className="row align-items-center justify-content-center ">
                ...
                <div className="container align-items-center justify-content-center UpcomingLive col-md-6"
                    ...
                    <div className="container xyz-auditions"> <br />
                        ...
                        <div className="container d-flex  align-items-center justify-content-center">
                            <b className="Upc-live-s">12<span className="Upc-live-h">H</span> 35<span
                                    className="Upc-live-h">M</span></b>
                        </div>

                        <div className="container d-flex  align-items-center justify-content-center">
                            <button
                                className="container d-flex  Upc-live-h-btn align-items-center justify-content-center">Remind
                                me</button>
                        </div>
