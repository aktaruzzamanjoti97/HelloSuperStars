...
import { sportCategoryData } from '../fakeCategoryData';

const SportCategorySlide = () => {
    

        const [list, setList] = useState([]);
    
        useEffect(() => {
            setList(sportCategoryData)
        }, [list])
    ...
    return (
        ...
        <div className="p-1 sliderCategory">
            <div className="d-flex">
                ...
                <small className="text-white mx-2"> Sport - Category </small>
            </div>
...
export default SportCategorySlide;