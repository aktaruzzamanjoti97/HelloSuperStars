...
export default function UpcomingAuditionsContent({ post }) {
  ...
  console.log("post from audtion ", post);
  ...
  const handleRouteChange = (audition_id) =>{
    history.push(`/participant-audition/${audition_id}`)
}
      ...
      {post.type === "meetup" ? (
        <div className="container align-items-center justify-content-center col-11 Enroll-Auditions">
          <div className="card Enroll-AuditionsB">
            ...
            <h5 className="my-2 Enroll-a Enroll-text text-justify ">
              {post.meetup.title}
            </h5>
            ...
            <div className="card PostCard">
              <Link
                to={`/starprofile/${post.meetup.star_id}/meetup-events/book_now/${post.event_id}`}
                className="link-starPorfile"
              >
                <img
                  src={mediaBaseUrl + post.meetup.banner}
                  alt={post.meetup.banner}
                />
              </Link>
              ...
              <div className="centered centered-meet">
                <div className="meetP  d-flex justify-content-between">
                  <div className="MeetupText col-md-8 fw-bold">
                    Meetup{" "}
                    {post.meetup?.meetup_type === "Online" ? (
                      <>(Online)</>
                    ) : (
                      <>(Offline)</>
                    )}
            ...
            <div className="row align-items-center justify-content-center ">
              <div className="container ">
                <ul className="PostHoUl Co-Auditions">
                  ...
                  <li className="share-post">
                    <small className="profile-card-text">100K Share</small>
                  </li>
                  <li className="comment-post">
                    <small className=" profile-card-text">60K Comment</small>
                  </li>
                </ul>
              </div>
              ...
              <div className="text-center hr-Auditions">
                ...
                <button
                  className="btn-warning-post mx-2 "
                  variant="link"
        ...
        <div className="container align-items-center justify-content-center col-11 Enroll-Auditions">
          <div className="card Enroll-AuditionsB">
            ...
            <div className="card PostCard">
              <img
                src={mediaBaseUrl + post.livechat?.banner}
                alt={post.livechat?.banner}
              />

              <div className="centered centered-meet">
                <div className="meetP  d-flex">
                  <div className="MeetupText col-md-8 fw-bold">Live Chat</div>
                  <div className="Meetupbtn col-md-3 align-items-center justify-content-center">
                    ...
                    <Link
                      to={`/starprofile/${post.livechat?.star_id}/livechat`}
                      className="link-starPorfile"
                    >
                      <button className="btn btn-warning text-light fw-bold bmt">
                        Book Now
        ...
        <div className="container align-items-center justify-content-center col-11 Enroll-Auditions">
          <div className="card Enroll-AuditionsB">
            ...
            <div className="card PostCard">
              <img
                src={mediaBaseUrl + post.learning_session?.banner}
                alt={post.learning_session?.banner}
              />
                ...
                <div className="meetP  d-flex">
                  ...
                  <div className="Meetupbtn col-md-3 align-items-center justify-content-center">
                    ...
                    <Link
                      ...
                      className="link-starPorfile"
                    >
                      <button className="btn btn-warning text-light fw-bold bmt w-100">
                        Register Now
                      </button>
                    </Link>
                  </div>
                  ...
                  <div className="card Enroll-AuditionsB">
                      ...
                      <div className="row align-items-center justify-content-center ">
                            ...
                            <div className="container align-items-center justify-content-center UpcomingAuditions col-md-6"
                                style={{ backgroundImage: `url(http://localhost:8000/${post.audition?.banner})` }}>
                                <div className="container xyz-auditions"> <br />
                                    <div className="container d-flex xyz-audition align-items-center justify-content-center">
                                        {post.judge?.map((judge)=>(

                                            <img src={`http://localhost:8000/${judge?.user?.image}`}  className="Pic-Auditions" alt={post.star?.profilePicture} />
                                        ...
                                        <p className="Pa-btn-text">{moment(post.audition?.start_time).format('LL')} - {moment(post.audition.end_time).format('LL')}</p>
                                    </div>

                                    <div className="container d-flex  align-items-center justify-content-center">

                                        <button onClick={()=>handleRouteChange(post.event_id)} className="container d-flex xyz-audition-btn align-items-center justify-content-center">Participate</button>
                            ...
                            <div className="container ">
                                <ul className="PostHoUl Co-Auditions">
                                    <li className="like-post"> 
                                        <i className="fas fa-heart heart mx-1 "></i>
                                        <small className="profile-card-text">{post.LikeCount}</small>
                                    </li>
                                    <li className="share-post">
                                        <small className="profile-card-text">{post.ShareCount} Share</small>
                                    </li>
                                    <li className="comment-post">
                                        <small className=" profile-card-text">{post.CommentCount} Comment</small>
                                    </li>
            ...
            {post.general?.type === "paid" ? (
              <div className="card PostCard">
                ...
                {post.general?.image ? (
                  <>
                    <img
                      src={mediaBaseUrl + post.general?.image}
                      alt={post.general?.image}
                      className="ImgBlur"
                    />
