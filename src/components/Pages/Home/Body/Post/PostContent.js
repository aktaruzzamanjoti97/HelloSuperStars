      ...
      {post.type === "meetup" ? (
        <div className="container align-items-center justify-content-center col-11 Enroll-Auditions">
          <div className="card Enroll-AuditionsB">
            ...
            <ShowMoreText
              ...
              more={
                <span
                  style={{ color: "gold", textDecoderation: "none!important" }}
                >
                  See more
                </span>
              }
        ...
        <div className="container align-items-center justify-content-center col-11 Enroll-Auditions">
          <div className="card Enroll-AuditionsB">
            ...
            <h5 className="my-2 Enroll-a Enroll-text">
              {post.livechat?.title}
            </h5>
            ...
            <ShowMoreText
              ...
              lines={3}
              more={
                <span style={{ color: "gold", textDecoderation: "none" }}>
                  See more
                </span>
              }
              less={
