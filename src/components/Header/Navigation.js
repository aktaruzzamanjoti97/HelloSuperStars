...
const Navigation = (props) => {
  ...
  const [notificationChatDropdown, setNotificationChatDropdown] =
    useState(false);
        ...
        <div className="bg-dark text-light  d-flex justify-content-between HeaderMobile">
          ...
          <div className="d-flex ">
            <form
              action=""
              role="search"
              className="search-form text-light btn"
            >
              <input
                type="search"
                name="q"
                className="search-text text-black"
                placeholder="Search..."
                autocomplete="off"
              />
            </form>
          ...
          <div className="navigation bg-dark text-light justify-content-between">
            ...
            <div className="d-flex mx-2">
              <div className="dropdown dropDownIconRemove">
                ...
                <div
                  className="container chatContainer dropdown-menu toggle"
                ...
                >
                  <div className="container mb-4 mt-2 form-group has-search">
                    ...
                    <input
                      type="text"
                      className="form-control search-design"
                        ...
                        <div className="text-white ms-1 profileName">
                          ...
                          >
                            ...
                            >
                              ...
                              <p className="text-margin-bottom">
                                <small>You have a schedule</small>
                              </p>
                            </button>
                          </a>
                        </div>
            ...
            <div className="d-flex mx-2">
              <div className="dropdown dropDownIconRemove">
                <div
                  ...
                  aria-expanded="false"
                >
                  <span className="notification_counter">{props.totalNotification}</span>
                ...
                >
                  {load
                        ...
                        >
                          <div className="borderBottomNotificationDropdown">
                            <div className="d-flex justify-content-between m-2">
                              ...
                              <div className="timeStampColor"></div>
                            </div>
                          </div>
                        </SkeletonTheme>
                      ))
                    : notifictions.map((data) => (
                        <div
                          className="borderBottomNotificationDropdown"
                          onClick={() =>
                                ...
                                <div className="text-decoration-none">
                                  <div className="link-open">
                                    <h6 className="text-margin-bottom">
                                      <b>{data.notification_text.type}</b>
                                    </h6>
                                    <p className="text-margin-bottom">
                                      <small>
            ...
            <div className="d-flex mx-2 DropX ">
              <i
                className="fa fa-bars circle-iconM "
            ...
            >
              <div closeButton className="ModalMobileB">
                <div variant="secondary" onClick={handleCloseMenu}>
                  ...
                  <span className="text-warning mx-2 LogoText">
                    Hello Superstars
                  </span>
                </div>
                <img
          ...
          <div className="container-fluid  custom-container-nv ">
            <Navbar.Brand href="#">
              <NavLink to="/">
                {" "}
                <img
                  src={helloSuperstarLogo}
                  alt="hello superstar logo"
              ...
              <Nav className="ms-auto my-2 my-lg-0 " navbarScroll>
                ...
                <Nav.Link className="navPadpd">
                  <NavLink to="/profile">
                    <img
                      src={accountImg}
                      className="img-fluid account-create"
                      alt="account create "
                    />
                  </NavLink>
                </Nav.Link>
