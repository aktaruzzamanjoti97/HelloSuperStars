        ...
        <Modal.Body className='PurModal '>
            <div className="row m-3">
                ...
                <div className="col-md-5 d-flex">
                    <img src={Pur} alt="" className='img-fluid PurImg' />
                </div>
                ...
                <div className="Delivery d-flex mt-4">
                    ...
                    <div className='d-flex BoxR mx-3 btn-light p-2'> <img src={Clock} alt="" className='DeliveryImg' /></div><span className='Box-Line mt-3'></span>
                    <div className='d-flex BoxR PenCol mx-3 btn-light p-2'> <img src={Delivery} alt="" className='DeliveryImg' /> </div><span className='Box-Line mt-3'></span>
                    <div className='d-flex BoxR PenCol mx-3 btn-light p-2'> <img src={Box} alt="" className='DeliveryImg' /></div>

                </div>

            </div>
            <i class="fas fa-times-circle text-warning top-right_cross"  onClick={props.onHide}></i>
